...
class AgroanimalPage extends StatefulWidget {
  @override
  _AgroanimalPageState createState() => _AgroanimalPageState();
}

class _AgroanimalPageState extends State<AgroanimalPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Contatos Agroanimal"),
      ),
      body: Center(
        child: Column(
          children: <Widget>[
